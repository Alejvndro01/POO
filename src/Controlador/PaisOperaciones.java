...
public class PaisOperaciones {
    ...
    public boolean codigoPaisExiste(String codigoPais) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al verificar el código de país: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
